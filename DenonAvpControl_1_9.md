A [Logitech Media Server](http://www.mysqueezebox.com/download) plugin to control the Denon AVP/POA and networked AVRs from the [Logitech Media Server](http://www.mysqueezebox.com/download) and
