This page describes how to install and configure the [Denon AVP/AVR Control](http://code.google.com/p/denonavpcontrol/) plugin for the [Logitech Media Server](http://www.mysqueezebox.com/download).
